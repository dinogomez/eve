...
<html lang="en">
            <!-- HEAD -->
              <head>
                <!-- LOGO -->
                <link rel="icon" href="../../library-resource/img/logos/eve_logo.png">
                <!-- Required meta tags -->
                <meta charset="utf-8">
                ...
                <link rel="stylesheet" type="text/css" href="admin-login-css/admin-security-login.css">
                <script type="text/javascript" src="admin-login-js/admin.js"></script>
