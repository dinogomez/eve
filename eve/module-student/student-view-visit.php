     ...
     <table class="table table-bordered">
       ...
       <tbody>
         ...
         while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
           ...
           "<a class='btn btn-warning' href='student-process/process-user-visit-delete-row.php?id=".$row['guestcode']."'><i class='fas fa-trash-alt black'> </i></a>
            <a class='btn btn-danger ml-1'><i class='fas fa-edit black'></i></a>"."</td></tr>";
          $rownum++;
        }

        // DELETE FROM `user_school_visit` WHERE `user_school_visit`.`id` = 70
